        # Cardio Trial Audit: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/cardio-trial-audit.git

        ## Objective

        CardioTrialAudit provides automated quality and integrity auditing of cardiovascular RCT data, flagging statistical inconsistencies and reporting anomalies.
        ...
        - Code: https://github.com/mahmood726-cyber/cardio-trial-audit.git
        - Dashboard: https://mahmood726-cyber.github.io/cardio-trial-audit/
